...
<body class="relative w-full min-h-screen bg-[#1F1F1F] text-[#e4d5b7] overflow-x-hidden">
    ...
    <aside class="fixed top-0 left-0 h-screen w-[380px] -translate-x-[300px] hover:translate-x-0 focus-within:translate-x-0 transition-transform duration-500 ease-out z-50">
        ...
        <div class="relative z-10 w-[280px] h-full flex flex-col pt-12 pl-10">
            ...
            <nav class="flex flex-col gap-8">
                <a href="home.php" class="text-[#eaddc5] hover:text-[#72685F] font-bold text-3xl tracking-widest uppercase transition-colors">
                    HOME
                </a>
                <a href="create-post.php" class="text-[#eaddc5] hover:text-[#72685F] font-bold text-3xl tracking-widest uppercase transition-colors">
                    CREATE POST
                </a>
                <a href="profile.php" class="text-[#eaddc5] hover:text-[#72685F] font-bold text-3xl tracking-widest uppercase transition-colors">
                    PROFILE
                </a>
                <a href="analytics.php" class="text-[#eaddc5] hover:text-[#72685F] font-bold text-3xl tracking-widest uppercase transition-colors">
                    ANALYTICS
                </a>
                <a href="awards.php" class="text-[#eaddc5] hover:text-[#72685F] font-bold text-3xl tracking-widest uppercase transition-colors">
                    AWARDS
                </a>
            </nav>
        </div>
    ...
    <main id="mainContent" class="relative z-10 min-h-screen flex flex-col px-8 py-6">
        ...
        <header class="flex justify-between items-center border-b border-gray-600 pb-3 mb-8">
            ...
            <div class="flex items-center gap-5 text-[#7A0A0A] uppercase text-3xl tracking-wide">
                <button class="underline underline-offset-4 hover:text-[#185FAC] transition-colors">FILTER</button>
            ...
            <div class="flex items-center gap-5">
                ...
                <a href="create-post.php"
                   class="w-16 h-16 flex items-center justify-center text-[#121110] text-xl font-black transition-colors">
        ...
        <div class="w-full max-w-4xl flex flex-col gap-3 mx-auto">
            ...
            <div class="w-full h-[400px] bg-[#121110] opacity-80 text-[#FAEAC9] text-3xl  flex items-center justify-center border-2 border-transparent rounded-xl">
                WORDS/IMAGE(post)
            </div>

            
            <div class="flex gap-6 text-[#E11C25] font-['Fira_Sans'] font-medium text-m mt-2">
