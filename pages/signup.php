    ...
    <div class="relative z-10 flex flex-col items-center justify-center min-h-screen py-6 sm:py-10 px-4">
        <div class="w-full max-w-6xl flex flex-col items-center">
            ...
            <div class="flex items-center justify-center gap-2 sm:gap-4 md:gap-8 mb-6 sm:mb-8">
                ...
                <h1 class="text-[#FAEAC9] text-3xl sm:text-5xl md:text-6xl tracking-widest uppercase text-center">Sign Up</h1>
            ...
            <form action="signup.php" method="POST" class="w-full max-w-lg flex flex-col gap-5">
                ...
                <div class="flex flex-col">
                    <label for="confirm" class="text-base sm:text-lg tracking-wide mb-1">Confirm Password:</label>
                    <div class="relative">
            ...
            <div class="flex flex-wrap items-center justify-center gap-3 sm:gap-6 mt-8 sm:mt-10 mb-6">
                ...
                <div class="flex flex-col items-center gap-1 text-base sm:text-lg">
                    ...
                    <a href="login.php" class="text-[#FAEAC9] font-bold tracking-widest underline decoration-2 underline-offset-4 hover:text-[#FAEAC9] transition-colors">
                        LOG IN
                    </a>
                </div>
